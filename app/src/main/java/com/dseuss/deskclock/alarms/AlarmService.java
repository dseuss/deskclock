...
public class AlarmService extends Service {
    ...
    public static final String ALARM_ALERT_ACTION = "com.dseuss.deskclock.ALARM_ALERT";

    // A public action sent by AlarmService when the alarm has stopped for any reason.
    public static final String ALARM_DONE_ACTION = "com.dseuss.deskclock.ALARM_DONE";
