...
/**
 * Class to measure and draw the time in the {@link com.dseuss.deskclock.CircleTimerView}.
...
public class CountingTimerView extends View {
     ...
     * {@link com.dseuss.deskclock.CircleTimerView#onDraw(android.graphics.Canvas)}
     */
