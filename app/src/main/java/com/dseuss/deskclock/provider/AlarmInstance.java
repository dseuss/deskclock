...
package com.dseuss.deskclock.provider;
...
import com.dseuss.deskclock.Log;
import com.dseuss.deskclock.R;
import com.dseuss.deskclock.SettingsActivity;
...
public final class AlarmInstance implements ClockContract.InstancesColumns {
    ...
    private static final int LIGHT_ALARM_ENABLED_INDEX = 11;

    private static final int COLUMN_COUNT = LIGHT_ALARM_ENABLED_INDEX + 1;
    ...
    public static ContentValues createContentValues(AlarmInstance instance) {
        ...
        values.put(LIGHT_ALARM_ENABLED, instance.mLightAlarmEnabled ? 1 : 0);
        return values;
    }
    ...
    public boolean mLightAlarmEnabled;
    ...
    public AlarmInstance(Cursor c) {
        ...
        mLightAlarmEnabled = c.getInt(LIGHT_ALARM_ENABLED_INDEX) == 1;
    }
    ...
    public String toString() {
        return "AlarmInstance{" +
                ...
                ", mLightAlarmEnabled=" + mLightAlarmEnabled +
                '}';
    }
}
