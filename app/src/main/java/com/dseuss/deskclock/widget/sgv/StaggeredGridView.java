...
package com.dseuss.deskclock.widget.sgv;
...
public class StaggeredGridView extends ViewGroup {
    ...
    private List<Animator> addUpdateViewPositionsAnimators(List<Animator> animators,
            boolean cascadeAnimation, SgvAnimationHelper.AnimationIn animationInMode, int startDelay) {
        final int childCount = getChildCount();
        if (childCount == 0) {
            return null;
        }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (viewRectPair != null && viewRectPair.rect != null) {
                ...
                xTranslation = 0;
                yTranslation = (animationInMode == SgvAnimationHelper.AnimationIn.FLY_IN_NEW_VIEWS) ? getHeight() : 0;
